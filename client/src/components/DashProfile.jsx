...
export default function DashProfile() {
    ...
    uploadTask.on(
      ...
      (error) => {
        setImageFileUploadError(
          "No se pudo subir (el archivo no puede superar las 2 MB"
        );
  ...
  const handleSubmit = async (e) => {
    ...
    setUpdateUserError('No hubo cambios')
      return;
    }
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setUpdateUserSuccess('La foto de perfil se cargo exitosamente')
      }
    } catch (error) {
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <TextInput
          ...
          onChange={handleChange}
        />
        <Button disabled={imageFileUploading} type="submit" gradientDuoTone="purpleToBlue" outline>
          Actualizar
        </Button>
      </form>
