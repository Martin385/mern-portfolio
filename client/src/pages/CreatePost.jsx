...
} from "firebase/storage";import {app} from '../firebase'
    ...
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      ...
      <form className="flex flex-col gap-4">
        ...
        <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
          ...
          >
            {
              imageUploadProgess ? <div className="w-16 h-16">
                <CircularProgressbar value={imageUploadProgess} text={`${imageUploadProgess || 0}%`}></CircularProgressbar>
              </div>
              : 'Subir imagen'
            }
          </Button>
